...
if(isset($_POST[submit]))
{
	if(isset($_SESSION[adminid]))
	{
		...
		{
			echo "<div class='alert alert-warning text-capitalize'>"
            .mysqli_error($conn).
            "</div>";
		}	
	}
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="adminname" placeholder="Admin Name" id="adminname"
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="loginid" placeholder="Login ID" id="loginid"
